define(["require", "exports", "esri/Map", "esri/views/MapView", "esri/geometry/Point", "esri/layers/FeatureLayer", "esri/geometry/SpatialReference", "esri/geometry/projection", "dojo/store/Memory", "dstore/legacy/StoreAdapter", "dgrid/OnDemandGrid"], function (require, exports, EsriMap, MapView, Point, FeatureLayer, SpatialReference, Projection, Memory, StoreAdapter, OnDemandGrid) {
    "use strict";
            ...
            view.on('click', function (event) {
                ...
                map.ground.queryElevation(event.mapPoint, {
                    ...
                    statePlaneLayer.queryFeatures(query).then(function (statePlaneResults) {
                        ...
                        var newData = layer.source.map(function (l) { return l.get('attributes'); });
