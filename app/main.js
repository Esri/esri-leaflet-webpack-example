define(["require", "exports", "esri/Map", "esri/views/MapView", "esri/geometry/Point", "esri/layers/FeatureLayer", "esri/geometry/SpatialReference", "esri/geometry/projection", "dstore/Memory", "dgrid/OnDemandGrid"], function (require, exports, EsriMap, MapView, Point, FeatureLayer, SpatialReference, Projection, Memory, OnDemandGrid) {
    "use strict";
            ...
            view.on('click', function (event) {
                ...
                map.ground.queryElevation(event.mapPoint, {
                    ...
                    statePlaneLayer.queryFeatures(query).then(function (statePlaneResults) {
                        ...
                        // console.log('point', point);
                        // console.log('dataStore', dataStore)
                        dataStore.forEach(function (x, i) { return console.log(i, x); });
